...
class CrateDummyDataTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        // division generate auto 

        DB::insert("INSERT INTO `divisions` (`id`, `name`, `bn_name`, `url`) VALUES
        ...
        // district generate auto 
        DB::insert("INSERT INTO `districts` (`id`, `division_id`, `name`, `bn_name`, `lat`, `lon`, `url`) VALUES
